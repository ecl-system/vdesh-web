...
import { visaConsultingSegments } from '@/client/utils/utils'

const VisaConsulting = () => {
    return (
        <section className="visaConsulting_main_section container container-lg">
            {/* row-1 */}
            ...
            <div className="row1_height rightBlock">
                <SharedImage src={centralizeImages?.visaConsultingImage} alt="bg-image" />
            </div>
            ...
            <div className="row2_height rightBlock">
                ...
                <div className="segment_container">
                    <div className="segmentsBlock">
                        {visaConsultingSegments.map((segment, index) => (
